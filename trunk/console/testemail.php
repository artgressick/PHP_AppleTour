<?	
	...
	$email['chrSubject'] = "TEST: ".$email['chrSubject'];
	
	$to = $_SESSION['chrEmail'];
	
	$from = $info['chrEmailName'].' <'.$info['chrFromEmail'].'>';
	
	require($BF. 'includes/_emailer.php');
	sendemail($to,$from,$email['chrSubject'],$email['txtBody']);
...
?>
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0" class='title_fade'>
		<tr>
			<td class="left"></td>
			<td class="title"><?=$info['chrTitle']?> Test E-mail for <?=$emailtype['chrType']?> E-mail.</td>
	...
	<div id='errors'></div>
	<div class='innerbody'>
		<div>An e-mail was sent sent to your E-mail Address.  Keep in mind Cancel Links will not function and we added "TEST:" to the begining of the subject of the e-mail.</div>
		<div style='padding-top:10px;'><input type='button' value='Back' onclick='location.href="email_setup.php?id=<?=$info['ID']?>"' /></div>
	</div>
<?
